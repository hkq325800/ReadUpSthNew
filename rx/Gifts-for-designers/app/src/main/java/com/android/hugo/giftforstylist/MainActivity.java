...
public class MainActivity extends AppCompatActivity {
    ...
    private void initView() {
        ...
        Typeface tvFontFace = Typeface.createFromAsset(getAssets(),
                "font/Lobster.ttf");
...
//                            editTextRGB.setText("");
    ...
    private void changeToRGB(String s) {
        int red = Integer.parseInt(String.valueOf(s.charAt(0)) + s.charAt(1),
                16);
        int green = Integer.parseInt(String.valueOf(s.charAt(2)) + s.charAt(3),
                16);
        int blue = Integer.parseInt(String.valueOf(s.charAt(4)) + s.charAt(5),
                16);
        ...
        Subscriber subscriber = new Subscriber() {
            ...
            public void onStart() {
                ...
                green = Integer.parseInt(
                        String.valueOf(s.charAt(2)) + s.charAt(3), 16);
                blue = Integer.parseInt(
                        String.valueOf(s.charAt(4)) + s.charAt(5), 16);
    ...
    public void setBackground(String color, int mark) {
        ...
        paramInteger.addUpdateListener(
                new ValueAnimator.AnimatorUpdateListener() {
                    public void onAnimationUpdate(ValueAnimator paramAnonymousValueAnimator) {
                        relativeLayout.setBackgroundColor(
                                (Integer) paramAnonymousValueAnimator.getAnimatedValue());
                    }
                }
